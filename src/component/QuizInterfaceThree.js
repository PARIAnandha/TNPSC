...
import questionsData from '../questions23.json';
import Header from './Header';
import Sidebar from './Sidebar';

const QuizInterfaceThree= () => {
  const [selectedAnswer, setSelectedAnswer] = useState('');
  const [selectedNumber, setSelectedNumber] = useState(1); // Default to the first question
...
export default QuizInterfaceThree;
